...
ntags_test_table <- tibble(
  ...
  test = c(rep(c("20cmcircle_10p_10s_750d_1","20cmcircle_5p_10s_750d_1", "20cmcircle_10p_10s_750d_2", "20cmcircle_5p_10s_750d_2"), length.out = X)),
    tag_A = c(1:7,9:11), 
  tag_B = c(1:7,9:11),
...
Date_Time >= as.POSIXct("2024-01-27 00:13:00", tz = "America/New_York") & Date_Time <=  as.POSIXct("2024-01-27 00:18:00", tz = "America/New_York") ~ "20cmcircle_10p_10s_750d_1_NA", 

Date_Time >= as.POSIXct("2024-01-27 00:20:00", tz = "America/New_York") & Date_Time <= as.POSIXct("2024-01-27 00:25:00", tz = "America/New_York") ~ "20cmcircle_5p_10s_750d_1_NA",

Date_Time >= as.POSIXct("2024-01-27 00:26:00", tz = "America/New_York") & Date_Time <= as.POSIXct("2024-01-27 00:31:00", tz = "America/New_York") ~ "20cmcircle_10p_10s_750d_2_NA",

Date_Time >= as.POSIXct("2024-01-27 00:33:00", tz = "America/New_York") & Date_Time <= as.POSIXct("2024-01-27 00:38:00", tz = "America/New_York") ~ "20cmcircle_5p_10s_750d_2_NA",
